    ...
    features: [
      {
        icon: 'smartphone',
        title: '移动优先设计',
        desc: '专为移动端打造的直观界面，支持 iOS 和 Android。完整的 SSH 终端体验，命令历史与收藏，设备管理一应俱全。',
      },
      {
        icon: 'hub',
        title: 'Mesh 网格网络',
      ...
      },
      {
        icon: 'psychology',
        title: 'AI 智能助手',
        desc: '集成 Claude、Gemini、OpenAI 等 AI 模型。支持语音输入，自然语言转命令，智能操作建议，让运维更高效。',
      },
      {
        icon: 'speed',
        title: '快速部署',
...
npm run ios   # 或 npm run android`,
    ...
    footer: {
      ...
      github: 'GitHub',
      feedback: '反馈',
      copy: '© 2026 Shadow Shuttle (影梭). All rights reserved.',
    ...
    features: [
      {
        ...
        desc: 'Intuitive interface crafted for mobile devices. Complete SSH terminal experience with command history, favorites, and device management on iOS and Android.',
      },
      {
        icon: 'hub',
        title: 'Mesh Network',
      ...
      },
      {
        ...
        desc: 'Integrated Claude, Gemini, OpenAI and more. Voice input, natural language to command conversion, and intelligent suggestions for efficient operations.',
      },
      {
        icon: 'speed',
...
npm run ios   # or npm run android`,
    ...
    footer: {
      ...
      github: 'GitHub',
      feedback: 'Feedback',
      copy: '© 2026 Shadow Shuttle. All rights reserved.',
      tech: 'Built with Go + React Native · Powered by WireGuard & Headscale',
    },
  },
} as const;
